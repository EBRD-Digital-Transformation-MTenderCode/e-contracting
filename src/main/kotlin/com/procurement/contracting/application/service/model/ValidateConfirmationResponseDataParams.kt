...
class ValidateConfirmationResponseDataParams private constructor(
    val cpid: Cpid,
    val ocid: Ocid,
    ...
    companion object {
        ...
        fun tryCreate(
        ...
        ): Result<ValidateConfirmationResponseDataParams, DataErrors> {
            ...
            return ValidateConfirmationResponseDataParams(
                cpid = parsedCpid,
                ocid = parsedOcid,
                contracts = contracts
            ).asSuccess()
