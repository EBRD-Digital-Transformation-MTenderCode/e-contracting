...
class CommandService(private val historyDao: HistoryDao,
    ...
    fun execute(cm: CommandMessage): ResponseDto {
        ...
        val response = when (cm.command) {
            ...
            CommandType.BUYER_SIGNING_AC -> treasuryAcService.buyerSigningAC(cm)
            CommandType.SUPPLIER_SIGNING_AC -> treasuryAcService.supplierSigningAC(cm)
            ...
            CommandType.ACTIVATION_AC -> treasuryAcService.activationAC(cm)
        }
