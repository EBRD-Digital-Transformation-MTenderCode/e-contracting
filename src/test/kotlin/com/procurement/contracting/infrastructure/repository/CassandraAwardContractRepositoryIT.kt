...
class CassandraAwardContractRepositoryIT {
    companion object {
        ...
        private val AC_STATUS = AwardContractStatus.PENDING
        private val AC_STATUS_AFTER_CANCEL = AwardContractStatus.CANCELLED
        private val AC_STATUS_AFTER_UPDATE = AwardContractStatus.UNSUCCESSFUL
        private val AC_STATUS_DETAILS = AwardContractStatusDetails.VERIFIED
        private val AC_STATUS_DETAILS_AFTER_CANCEL = AwardContractStatusDetails.EMPTY
        private val AC_STATUS_DETAILS_AFTER_UPDATE = AwardContractStatusDetails.EMPTY
    ...
    fun init() {
        ...
        acRepository = CassandraAwardContractRepository(session)
    }
    ...
    fun findBy() {
        ...
        val actualFundedAC: AwardContractEntity? = acRepository.findBy(cpid = CPID, id = AWARD_CONTRACT_ID).get()
    ...
    fun acNotFound() {
        val actualFundedAC =
            acRepository.findBy(cpid = Cpid.orNull("ocds-b3wdp1-MD-0000000000000")!!, id = AWARD_CONTRACT_ID).get()
    ...
    fun errorRead() {
        ...
        acRepository.findBy(cpid = CPID, id = AWARD_CONTRACT_ID).assertFailure()
    }
    ...
    fun updateStatusesAC() {
        ...
        val actualACEntity: AwardContractEntity? = acRepository.findBy(cpid = CPID, id = AWARD_CONTRACT_ID).get()
    ...
    private fun insertAC(
        status: AwardContractStatus = AC_STATUS,
        statusDetails: AwardContractStatusDetails = AC_STATUS_DETAILS,
    ...
    private fun expectedFundedAC() = AwardContractEntity(
        cpid = CPID,
        id = AWARD_CONTRACT_ID,
        token = TOKEN,
        owner = OWNER,
